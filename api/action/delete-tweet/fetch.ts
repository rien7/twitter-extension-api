...
import type { DeleteTweetOriginalResponse, DeleteTweetResolvedRequest } from './types';

export async function fetchDeleteTweetResponse(
  request: DeleteTweetResolvedRequest
): Promise<DeleteTweetOriginalResponse> {
