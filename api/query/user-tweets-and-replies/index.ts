...
const USER_TWEETS_AND_REPLIES_DOC = `# user-tweets-and-replies

Fetch a user's tweets-and-replies timeline via Twitter/X GraphQL.

Request type: UserTweetsAndRepliesRequest
Response type: UserTweetsAndRepliesResponse
...
const userTweetsAndRepliesDesc: XApiDesc = {
  id: 'user-tweets-and-replies',
  title: 'User Tweets And Replies Timeline',
  doc: USER_TWEETS_AND_REPLIES_DOC,
  match: {
    method: 'GET',
...
async function userTweetsAndRepliesImpl(
  ...
  const requestUrl = buildUserTweetsAndRepliesUrl(resolved);
...
function normalizeUserTweetsAndRepliesResponse(
...
export const userTweetsAndReplies = Object.assign(userTweetsAndRepliesImpl, {
  __desc: userTweetsAndRepliesDesc
}) as XCallableApi<UserTweetsAndRepliesRequest, UserTweetsAndRepliesResponse>;
