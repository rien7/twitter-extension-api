...
export interface UserTweetsTweetSummary {
  entryId: string;
  sortIndex?: string;
  tweetId?: string;
  fullText?: string;
  ...
  viewCount?: string;
  user?: UserTweetsUserSummary;
  stats?: UserTweetsTweetStats;
  viewerState?: UserTweetsViewerState;
}

export interface UserTweetsUserSummary {
  userId?: string;
  name?: string;
  screenName?: string;
  verified?: boolean;
...
export interface UserTweetsTweetStats {
  replyCount?: number;
  retweetCount?: number;
  likeCount?: number;
  quoteCount?: number;
...
export interface UserTweetsViewerState {
  bookmarked?: boolean;
  favorited?: boolean;
  retweeted?: boolean;
}
