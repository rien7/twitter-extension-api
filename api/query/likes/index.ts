...
Fetch a user's liked-tweets timeline via Twitter/X GraphQL.

Request type: LikesRequest
Response type: LikesResponse
...
async function likesImpl(input: LikesRequest = {}): Promise<LikesResponse> {
  ...
  const requestUrl = buildLikesUrl(resolved);
...
function normalizeLikesResponse(payload: LikesOriginalResponse): LikesResponse {
...
export const likes = Object.assign(likesImpl, {
  __desc: likesDesc
}) as XCallableApi<LikesRequest, LikesResponse>;
