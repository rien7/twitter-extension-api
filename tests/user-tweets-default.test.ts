...
import {
  ...
  buildUserTweetsRequest
} from '../api/query/user-tweets/default';

describe('userTweets defaults', () => {
  afterEach(() => {
  ...
  it('allows overrides while keeping userId as highest-priority field', () => {
    ...
    expect(request.variables.withQuickPromoteEligibilityTweetFields).toBe(false);
